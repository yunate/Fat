...
DSTATUS assign_drives(BYTE nDiskNum);	/* Initialization of low level I/O module */
DSTATUS disk_status(BYTE nDiskNum);
DSTATUS disk_initialize (BYTE nDiskNum);
DRESULT disk_read (BYTE nDiskNum, BYTE* buff, DWORD sector, UINT count);
DRESULT disk_write (BYTE nDiskNum, const BYTE* buff, DWORD sector, UINT count);
DRESULT disk_ioctl (BYTE nDiskNum, BYTE cmd, void* buff);
